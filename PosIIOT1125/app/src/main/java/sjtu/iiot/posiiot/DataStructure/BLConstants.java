...
public interface BLConstants {
    ...
    public static final String URL_Service = "http://202.120.36.137:5000/";//http://202.120.36.137:5000/";//"http://192.168.1.100/";//"http://61.129.93.20/xtalball/Beacon/Services/";
    ...
    public static final String API_LOGIN = URL_Service + "mobile_login/";
    ...
    public static final String ARG_USER_PWD = "passwd";
    public static final String ARG_USER_NEW_PWD = "newpassword";
    public static final String ARG_USER_NAME = "name";
    public static final String ARG_USER_GENDER = "sexual";
    public static final String ARG_USER_PHONE = "mobile";
